...
public class UserController {
    ...
    public Object register(@RequestBody User user) {
        ...
        if (exUser == null) {
            ...
            exUser = userService.getUser(user.getEmail());
            exUser.setRides(new ArrayList<>());
    ...
    public Object getRides(@RequestBody User user) {

        User exUser = userService.getByUserId(user.getUserId());
        if (exUser != null && exUser.getPassword().equals(user.getPassword()))
            return new ResponseEntity<>(userService.getUserRide(user.getUserId()), HttpStatus.OK);
